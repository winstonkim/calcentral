module CalCentralPages
  ...
  class MyDashboardTasksCard < MyDashboardPage
    ...
    elements(:overdue_task_notes, :div, :xpath => '//li[@data-ng-repeat="task in overdueTasks | limitTo: overdueLimit"]//div[@data-cc-compile-directive="task.notes | linky"]')
    ...
    elements(:today_task_notes, :div, :xpath => '//li[@data-ng-repeat="task in dueTodayTasks | limitTo: dueTodayLimit"]//div[@data-cc-compile-directive="task.notes | linky"]')
    ...
    elements(:future_task_notes, :div, :xpath => '//li[@data-ng-repeat="task in futureTasks | limitTo: futureLimit"]//div[@data-cc-compile-directive="task.notes | linky"]')
    ...
    elements(:unsched_task_notes, :div, :xpath => '//li[@data-ng-repeat="task in unscheduledTasks | limitTo:unscheduledLimit"]//div[@data-cc-compile-directive="task.notes | linky"]')
