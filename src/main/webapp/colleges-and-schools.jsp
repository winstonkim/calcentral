...
<body class="cc-page-colleges-and-schools">
	...
	<div class="cc-container-main cc-container-main-full" role="main">
        ...
        {{#each_object collegesandschools}}
        	<li><a {{#if value.cssclass}} class="cc-page-colleges-and-schools-item-{{value.cssclass}}"{{/if}} href="/classlist.jsp">{{value.title_prefix}}<br /><span class="cc-page-colleges-and-schools-title">{{value.title}}</span></a></li>
        {{/each_object}}
        </ul>
        </script>
