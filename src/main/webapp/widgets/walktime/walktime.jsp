...
#cc-widget-walktime #walktime_map_container {
	width: 200px;
	height: 200px;
}

#cc-widget-walktime #walktime_answer {
	font-size: 1.2em;
	color: #323D71;
	font-weight: bold;
}

#cc-widget-walktime #walktime_startpoint, #cc-widget-walktime #walktime_endpoint {
	width: 100%;
}
</style>

<div id="cc-widget-walktime">
	<!-- MAIN VIEW -->
	<div id="walktime_main" style="display:none;">
	...
	<div class="s3d-widget-footer">
		<a class="walktime_item_link s3d-widget-links" id="walktime_footermap_link" href="#">&raquo; View larger map</a>
	</div>
</div>
...
calcentral.widgets.walktime = function(tuid, showSettings) {
	...
	var doInit = function () {
		...
		$.ajax({
			 type: 'GET',
			 url: '/widgets/walktime/map_coordinates.xml',
			 dataType: 'xml',
