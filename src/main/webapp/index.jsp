...
<body class="cc-index">
	...
	<div class="cc-container-main" role="main">
		<div class="cc-index-welcome cc-index-welcome1">
			<h3><strong>Unifying</strong> the online experience at <strong>UC Berkeley!</strong></h3>
			<p><strong>CalCentral</strong> is a new resource for the <strong>UC Berkeley community</strong>.</p>
		</div>
		<div class="cc-index-welcome cc-index-welcome2">
			...
			<p class="cc-index-welcome2-handshake"><span class="cc-index-welcome2-herefromyou">We want to hear from you!</span><br /><a href="http://ets.berkeley.edu/calcentral-feedback">Tell us what you think</a>.</p>
		</div>
	</div>
  <hr class="clearfix" />
	<tags:footer/>
